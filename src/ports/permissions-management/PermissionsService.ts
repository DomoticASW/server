...
export interface PermissionsService {
  ...
  findUserDevicePermission(
    ...
    email: Email,
    deviceId: DeviceId
  ): Effect<UserDevicePermission, TokenError | UserDevicePermissionNotFoundError>
  findAllUserDevicePermissionsOfAnUser(
    token: Token,
    email: Email
  ): Effect<Iterable<UserDevicePermission>, UserNotFoundError | TokenError>
  getAllUserDevicePermissions(token: Token): Effect<Iterable<UserDevicePermission>, TokenError>
  addUserDevicePermission(
    token: Token,
    email: Email,
    devideId: DeviceId
  ): Effect<void, UserNotFoundError | DeviceNotFoundError | TokenError>
  ...
  canExecuteActionOnDevice(
    token: Token,
    deviceId: DeviceId
  ): Effect<void, PermissionError | InvalidTokenError>
  canExecuteTask(
    token: Token,
    taskId: TaskId
  ...
  findEditList(
    token: Token,
    scriptId: ScriptId
  ): Effect<EditList, TokenError | EditListNotFoundError>
  getAllEditLists(token: Token): Effect<Iterable<EditList>, TokenError>
  addToEditlist(
    token: Token,
    email: Email,
    scriptId: ScriptId
  ): Effect<void, TokenError | UserNotFoundError | ScriptNotFoundError | EditListNotFoundError>
  addToEditlistUnsafe(
    email: Email,
    scriptId: ScriptId
  ): Effect<void, UserNotFoundError | ScriptNotFoundError | EditListNotFoundError>
  removeFromEditlist(
    token: Token,
    email: Email,
    scriptId: ScriptId
  ...
  findTaskLists(
    token: Token,
    taskId: TaskId
  ): Effect<TaskLists, TokenError | TaskListsNotFoundError>
  getAllTaskLists(token: Token): Effect<Iterable<TaskLists>, TokenError>
  addToWhitelist(
    token: Token,
    email: Email,
    taskId: TaskId
  ): Effect<void, TokenError | UserNotFoundError | ScriptNotFoundError | InvalidOperationError>
  removeFromWhitelist(
    token: Token,
    email: Email,
    taskId: TaskId
  ): Effect<void, TokenError | UserNotFoundError | ScriptNotFoundError>
  addToBlacklist(
    token: Token,
    email: Email,
    taskId: TaskId
