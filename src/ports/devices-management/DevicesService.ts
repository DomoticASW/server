...
import { DeviceUnreachableError, DeviceNotFoundError, DevicePropertyNotFound, DeviceAlreadyRegisteredError, CommunicationError } from "./Errors.js";
...
export interface DevicesService {
    add(token: Token, deviceAddress: DeviceAddress): Effect<DeviceId, DeviceAlreadyRegisteredError | DeviceUnreachableError | CommunicationError | TokenError>;
