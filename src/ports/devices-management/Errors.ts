...
export function InvalidInputError(cause?: string): InvalidInputError {
    return { message: "The given value is not valid a valid input", cause: cause, __brand: "InvalidInputError" }
}
...
export function DeviceActionError(cause?: string): DeviceActionError {
    return { message: "Something went wrong while executing this action", cause: cause, __brand: "DeviceActionError" }
}
...
export function DeviceActionNotFound(cause?: string): DeviceActionNotFound {
    return { message: "This device action was not found", cause: cause, __brand: "DeviceActionNotFound" }
}
...
export function DevicePropertyNotFound(cause?: string): DevicePropertyNotFound {
    return { message: "This device property was not found", cause: cause, __brand: "DevicePropertyNotFound" }
}
...
export function DeviceGroupNameAlreadyInUseError(cause?: string): DeviceGroupNameAlreadyInUseError {
    return { message: "This device group name is already used", cause: cause, __brand: "DeviceGroupNameAlreadyInUseError" }
}
...
export function DeviceGroupNotFoundError(cause?: string): DeviceGroupNotFoundError {
    return { message: "This device group was not found", cause: cause, __brand: "DeviceGroupNotFoundError" }
}
