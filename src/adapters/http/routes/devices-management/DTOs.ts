...
import { DeviceStatus, Device, DeviceAddress, DeviceEvent, DeviceAction, DeviceProperty } from "../../../../domain/devices-management/Device.js"
 ...
 */
export function DeviceGroupDTO(dg: DeviceGroup, devicesService: DevicesService): Effect.Effect<DeviceGroupDTO> {
    return pipe(
        Effect.allSuccesses(dg.devices.map(dId => devicesService.findUnsafe(dId)), { concurrency: "unbounded" }),
