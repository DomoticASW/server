...
export function Response(code: StatusCodes, body?: unknown): Response {
...
): Effect.Effect<Token, UnauthorizedError | InvalidTokenFormatError> {
...
export function handleCommonErrors(
  eff: Effect.Effect<
    Response,
    BadRequest | UnauthorizedError | InvalidTokenFormatError | InvalidTokenError | PermissionError
  >
