...
export class DeviceGroupRepositoryMongoAdapter extends BaseRepositoryMongoAdapter<
  DeviceGroupId,
  DeviceGroup,
  string,
  DeviceGroupSchema
> {
  ...
  constructor(connection: mongoose.Connection) {
    super(connection)
    this.DG = connection.model("DeviceGroup", this.deviceGroupSchema, undefined, {
  ...
  protected toDocument(
    e: DeviceGroup
  ): mongoose.Document<unknown, object, DeviceGroupSchema> & DeviceGroupSchema {
